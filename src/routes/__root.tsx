...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "LensMark" },
    ...
    links: [
      ...
      { rel: "preconnect", href: "https://lytuauhqegewdhhcqzfl.supabase.co", crossOrigin: "anonymous" },
      { rel: "dns-prefetch", href: "https://lytuauhqegewdhhcqzfl.supabase.co" },
      {
        rel: "stylesheet",
      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var k='lensmark.theme';var s=localStorage.getItem(k);var d=s==='dark';var r=document.documentElement;if(d){r.classList.add('dark');}r.style.colorScheme=d?'dark':'light';}catch(e){}})();`,
          }}
        />
      </head>
      <body>
